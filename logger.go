...
//
// Log creates an entry from an unspecified group of params. Note
// that the first string or error will be considered the Message and
// all others will be appended to the Context and a bool(true) will
// automatically populate the Timestamp and Location of the created
// entry. Fatal works the same way but will call os.Exit(1) when it's
// done.

...
func (l RowLog) Log(args ...interface{}) {
	l.log.Print(rowLog(3, l.opts, args), l.opts.RecordSep)
}
...
func (l RowLog) Fatal(args ...interface{}) {
	l.log.Fatal(rowLog(3, l.opts, args), l.opts.RecordSep)
}

// Write fulfills the io.Writer interface
func (l RowLog) Write(p []byte) (n int, err error) {
	l.log.Print(rowLog(4, l.opts, []any{string(p)}), l.opts.RecordSep)
	return len(p), nil
}
